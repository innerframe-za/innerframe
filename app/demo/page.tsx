...
/**
 * Demo / showcase page — demonstrates the falling leaves ambient animation.
 */
export default function DemoPage() {
  return (
    <>
      {/* Falling leaves render behind everything via fixed positioning */}
      ...
      <main className="relative" style={{ zIndex: 1 }}>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-sm md:text-base max-w-2xl mx-auto mb-16" style={{ color: '#5a5a5a' }}>
