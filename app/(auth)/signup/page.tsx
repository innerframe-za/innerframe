...
/**
 * Signup page — open self-registration via Supabase Auth.
 * Shows a confirmation prompt after successful submission.
 */
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: '#5a5a5a' }}>
            Get access to your Innerframe portal
          </p>
        </div>
        ...
        {submitted ? (
          ...
          <div className="text-center space-y-4">
            <div
              className="px-4 py-5 rounded-xl border text-sm"
              style={{
                backgroundColor: 'rgba(30,58,47,0.05)',
                borderColor: 'rgba(30,58,47,0.2)',
                color: '#1E3A2F',
              }}
            >
        ...
        {!submitted && (
          <p className="text-xs text-center mt-6" style={{ color: '#5a5a5a' }}>
            ...
            <Link href="/login" style={{ color: '#1E3A2F' }} className="font-medium underline">
              Sign in
            </Link>
          </p>
        )}
